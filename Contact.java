...
public class Contact {
	...
	public void searchByCity(String city) {
		List<PersonInformation> collect = contactList.stream().filter(p -> p.getCity().equalsIgnoreCase(city))
	...
	public void searchByState(String state) {
		List<PersonInformation> collect = contactList.stream().filter(p -> p.getState().equalsIgnoreCase(state))
				.collect(Collectors.toList());
		for (PersonInformation contact : collect) {
			System.out.println("Search result: " + contact);
		}
